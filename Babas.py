...
turtle.penup()
turtle.goto(0,0)  # Ajusta la posición vertical según sea necesario
turtle.color("Red")  # Color del texto
turtle.write("Te Quiero Babas n_n", align="center", font=("Helvetica", 50, "bold"))
